...
//   }
	...
	@UseGuards(FortyTwoAuthGuard)
		getHello(): string { return "hello there from oath" }

	@Get('unprotected_hoi')
		getUnpHello(): string { return "hello there from unprotected oath" }

	@Get('strategy_hoi')
	@UseGuards(FortyTwoStrategy)
		getStrHello(): string { return "hello there from startegy oath" }
